...
static void test_static_evaluation_counts_homeworld_ships_as_material_only(void) {
  HomeworldsPosition position = {0};
  ...
  assert(homeworlds_position_evaluate_static_with_weights(&position, &weights) == 0);
}
...
static void test_static_evaluation_counts_buildable_colors_once_per_green_system(void) {
  ...
  assert(homeworlds_position_evaluate_static(&position) == 140);
}
...
int main(void) {
  ...
  test_static_evaluation_counts_homeworld_ships_as_material_only();
