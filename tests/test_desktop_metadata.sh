...
ggame_schema_file="$repo_root/data/schemas/$ggame_settings_id.gschema.xml"
...
grep -q "<schema id=\"$ggame_settings_id\">" "$ggame_schema_file"
...
test -f "$install_root/prefix/share/glib-2.0/schemas/$ggame_settings_id.gschema.xml"
