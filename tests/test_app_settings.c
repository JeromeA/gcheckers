...
static void test_app_settings_defaults(void) {
  ...
  g_assert_false(gcheckers_app_settings_get_privacy_settings_shown(settings));
}
...
static void test_app_settings_mark_privacy_settings_shown(void) {
  ...
  g_assert_true(gcheckers_app_settings_mark_privacy_settings_shown(settings));
  g_assert_true(gcheckers_app_settings_get_privacy_settings_shown(settings));
}
