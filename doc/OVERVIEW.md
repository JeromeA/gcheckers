...
numeric fields must be plain decimal digits, and duplicate system entries or non-empty systems without a star are
rejected instead of being normalized into impossible positions.
